...
def main():
    ...
    if AUGMENTATION:
        predictors_save_path = os.path.join(OUTPUT_FOLDER, 'iemocap_actorsplit' + appendix + '_aug' + str(NUM_AUG_SAMPLES) + '_predictors.npy')
        target_save_path = os.path.join(OUTPUT_FOLDER, 'iemocap_actorsplit' + appendix + '_aug' + str(NUM_AUG_SAMPLES) + '_target.npy')
    else:
        predictors_save_path = os.path.join(OUTPUT_FOLDER, 'iemocap_actorsplit' + appendix + '_predictors.npy')
        target_save_path = os.path.join(OUTPUT_FOLDER, 'iemocap_actorsplit' + appendix + '_target.npy')
