...
num_classes_mormhomnist_morpholabel = 6

pretraining_dataset_path = '../dataset/matrices/morphomnist_morpholabel'
...
base_results = '../pretraining_vgg/morphomnist_morpholabel'
...
PREDICTORS_LOAD = os.path.join(pretraining_dataset_path, 'morphomnist_morpholabel_predictors.npy')
TARGET_LOAD = os.path.join(pretraining_dataset_path, 'morphomnist_morpholabel_target.npy')
...
#load model
par = ['output_classes=' + str(num_classes_mormhomnist_morpholabel)]
