...
INPUT_GSC_FOLDER = cfg.get('preprocessing', 'input_gsc_noisy_folder')
...
def main():
    ...
    if AUGMENTATION:
        predictors_save_path = os.path.join(OUTPUT_FOLDER, 'gsc_noisy_randsplit' + appendix + '_aug' + str(NUM_AUG_SAMPLES) + '_predictors.npy')
        target_save_path = os.path.join(OUTPUT_FOLDER, 'gsc_noisy_randsplit' + appendix + '_aug' + str(NUM_AUG_SAMPLES) + '_target.npy')
    else:
        predictors_save_path = os.path.join(OUTPUT_FOLDER, 'gsc_noisy_randsplit' + appendix + '_predictors.npy')
        target_save_path = os.path.join(OUTPUT_FOLDER, 'gsc_noisy_randsplit' + appendix + '_target.npy')
