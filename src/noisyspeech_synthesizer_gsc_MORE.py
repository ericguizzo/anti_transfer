...
output_dir = os.path.join(augmented_gsc_folder, 'noisy_MORE_balanced')
#output_dir = cfg.get('preprocessing', 'input_gsc_noisy_MORE_folder')

#output_dir = '../../shared_datasets/speechCmd/noisy_MORE_balanced'
...
if __name__=="__main__":
    ...
    # Configurations: read noisyspeech_synthesizer_gsc_MORE.cfg
    parser.add_argument("--cfg", default = "noisyspeech_synthesizer_gsc_MORE.cfg", help = "Read noisyspeech_synthesizer_gsc_MORE.cfg for all the details")
