...
generator = True
num_experiment = 1004  #id of the experiment
...
experiment[1] = ['comment_1="regular"', 'comment_2="no anti, pretraining nsynth"',
                 'anti_transfer=False', 'at_pretraining="nsynth"',
                 ]

experiment[2] = ['comment_1="regular"', 'comment_2="no anti, pretraining nsynth"',
                 'anti_transfer=False', 'at_pretraining="nsynth"',
                 ]

experiment[3] = ['comment_1="regular"', 'comment_2="no anti, pretraining nsynth"',
                 'anti_transfer=False', 'at_pretraining="nsynth"',
                 ]
