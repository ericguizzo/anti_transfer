...
short_description = 'baseline with no antitransfer, but with weight initialization'
dataset = 'iemocap_randsplit_spectrum_fast'
task_type = 'classification'
generator = True
num_experiment = 1000  #id of the experiment
...
experiment[1] = ['comment_1="regular"', 'comment_2="no anti, pretraining iemocap"',
                 'anti_transfer=False', 'at_pretraining="iemocap"',
                 ]

experiment[2] = ['comment_1="regular"', 'comment_2="no anti, pretraining iemocap"',
                 'anti_transfer=False', 'at_pretraining="iemocap"',
                 ]

experiment[3] = ['comment_1="regular"', 'comment_2="no anti, pretraining iemocap"',
                 'anti_transfer=False', 'at_pretraining="iemocap"',
                 ]

experiment[4] = ['comment_1="regular"', 'comment_2="no anti, pretraining iemocap"',
                 'anti_transfer=False', 'at_pretraining="iemocap"',
                 ]

experiment[5] = ['comment_1="regular"', 'comment_2="no anti, pretraining librispeech"',
                 'anti_transfer=False', 'at_pretraining="librispeech"',
                 ]
