...
generator = True
num_experiment = 1001  #id of the experiment
...
experiment[1] = ['comment_1="regular"', 'comment_2="no anti, pretraining librispeech"',
                 'anti_transfer=False', 'at_pretraining="librispeech"',
                 ]

experiment[2] = ['comment_1="regular"', 'comment_2="no anti, pretraining librispeech"',
                 'anti_transfer=False', 'at_pretraining="librispeech"',
                 ]

experiment[3] = ['comment_1="regular"', 'comment_2="no anti, pretraining librispeech"',
                 'anti_transfer=False', 'at_pretraining="librispeech"',
                 ]
