...
generator = True
num_experiment = 1006  #id of the experiment
...
experiment[1] = ['comment_1="regular"', 'comment_2="no anti, pretraining goodsounds"',
                 'anti_transfer=False', 'at_pretraining="goodsounds"',
                 ]

experiment[2] = ['comment_1="regular"', 'comment_2="no anti, pretraining goodsounds"',
                 'anti_transfer=False', 'at_pretraining="goodsounds"',
                 ]

experiment[3] = ['comment_1="regular"', 'comment_2="no anti, pretraining goodsounds"',
                 'anti_transfer=False', 'at_pretraining="goodsounds"',
                 ]
