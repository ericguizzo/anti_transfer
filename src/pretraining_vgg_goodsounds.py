...
base_results = '../pretraining_vgg/goodsounds'
...
PREDICTORS_LOAD = os.path.join(pretraining_dataset_path, 'goodsounds_INSTRUMENT_randsplit_spectrum_fast_predictors.npy')
TARGET_LOAD = os.path.join(pretraining_dataset_path, 'goodsounds_INSTRUMENT_randsplit_spectrum_fast_target.npy')
...
#load model
par = ['output_classes=' + str(num_instruments_goodsounds)]
