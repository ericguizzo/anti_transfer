...
pretraining_dataset_path = '../dataset/matrices/iemocap_1sec_actorsplit'
num_cnn_layers = cfg.getint('pretraining', 'num_cnn_layers')
preprocessing_ID = 'first'
sequence_length = 1
num_emotions_iemocap = 4
...
base_results = '../pretraining_vgg/iemocap_1sec'
...
PREDICTORS_LOAD = os.path.join(pretraining_dataset_path, 'iemocap_1sec_actorsplit_spectrum_fast_predictors.npy')
TARGET_LOAD = os.path.join(pretraining_dataset_path, 'iemocap_1sec_actorsplit_spectrum_fast_target.npy')
...
#load model
par = ['output_classes=' + str(num_emotions_iemocap)]
