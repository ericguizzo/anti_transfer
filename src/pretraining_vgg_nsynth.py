...
pretraining_dataset_path = '../dataset/matrices/nsynth/nsynth'
num_cnn_layers = cfg.getint('pretraining', 'num_cnn_layers')
preprocessing_ID = 'reduced'
sequence_length = 6
num_classes_nsynth = 11

#training parameters
experiment_name = '6secs'
gpu_id = 1
num_epochs = 50
batch_size = 30
learning_rate = 0.00005
regularization_lambda = 0.
base_results = '../pretraining_vgg/nsynth'
...
#load model
par = ['output_classes=' + str(num_classes_nsynth)]
