...
#beta 0.5
experiment[3] = ['comment_1="antitransfer"', 'comment_2="gram, mse_sigmoid_invorder, beta:0.5"',
                 'anti_transfer=True', 'at_beta=0.5',
                 'at_aggregation="gram"', 'at_distance="mse_sigmoid_invorder"']

experiment[4] = ['comment_1="antitransfer"', 'comment_2="gram, cos squared, beta:0.5"',
                 'anti_transfer=True', 'at_beta=0.5',
                 'at_aggregation="gram"', 'at_distance="cos_squared"']

#beta 1.
experiment[5] = ['comment_1="antitransfer"', 'comment_2="gram, mse_sigmoid_invorder, beta:1"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="gram"', 'at_distance="mse_sigmoid_invorder"']

experiment[6] = ['comment_1="antitransfer"', 'comment_2="gram, cos squared, beta:1"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="gram"', 'at_distance="cos_squared"']

#beta 2.
experiment[7] = ['comment_1="antitransfer"', 'comment_2="gram, mse_sigmoid_invorder, beta:2"',
                 'anti_transfer=True', 'at_beta=2.',
                 'at_aggregation="gram"', 'at_distance="mse_sigmoid_invorder"']

experiment[8] = ['comment_1="antitransfer"', 'comment_2="gram, cos squared, beta:2"',
                 'anti_transfer=True', 'at_beta=2.',
                 'at_aggregation="gram"', 'at_distance="cos_squared"']

#beta 5.
experiment[9] = ['comment_1="antitransfer"', 'comment_2="gram, mse_sigmoid_invorder, beta:20"',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="gram"', 'at_distance="mse_sigmoid_invorder"']

experiment[10] = ['comment_1="antitransfer"', 'comment_2="gram, cos squared, beta:20"',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="gram"', 'at_distance="cos_squared"']
