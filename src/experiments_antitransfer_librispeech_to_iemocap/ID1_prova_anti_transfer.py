...
short_description = 'IEMOCAP prova'
...
#beta 2
experiment[3] = ['comment_1="antitransfer"', 'comment_2="mean mse, beta:2"',
                 'anti_transfer=True', 'at_beta=2.', 'at_type="mean_mse"'
                 ]
experiment[4] = ['comment_1="antitransfer"', 'comment_2="mul mse, beta:2"',
                 'anti_transfer=True', 'at_beta=2.', 'at_type="mul_mse"'
                 ]
experiment[5] = ['comment_1="antitransfer"', 'comment_2="sum mse, beta:2"',
                 'anti_transfer=True', 'at_beta=2.', 'at_type="sum_mse"'
                 ]
#beta 5
experiment[6] = ['comment_1="antitransfer"', 'comment_2="mean mse, beta:5"',
                 'anti_transfer=True', 'at_beta=5.', 'at_type="mean_mse"'
                 ]
experiment[7] = ['comment_1="antitransfer"', 'comment_2="mul mse, beta:5"',
                 'anti_transfer=True', 'at_beta=5.', 'at_type="mul_mse"'
                 ]
experiment[8] = ['comment_1="antitransfer"', 'comment_2="sum mse, beta:5"',
                 'anti_transfer=True', 'at_beta=5.', 'at_type="sum_mse"'
                 ]

#beta 10
experiment[9] = ['comment_1="antitransfer"', 'comment_2="mean mse, beta:10"',
                 'anti_transfer=True', 'at_beta=10.', 'at_type="mean_mse"'
                 ]
experiment[10] = ['comment_1="antitransfer"', 'comment_2="mul mse, beta:10"',
                 'anti_transfer=True', 'at_beta=10.', 'at_type="mul_mse"'
                 ]
experiment[11] = ['comment_1="antitransfer"', 'comment_2="sum mse, beta:10"',
                 'anti_transfer=True', 'at_beta=10.', 'at_type="sum_mse"'
                 ]

#beta 20
experiment[12] = ['comment_1="antitransfer"', 'comment_2="mean mse, beta:20"',
                 'anti_transfer=True', 'at_beta=20.', 'at_type="mean_mse"'
                 ]
experiment[13] = ['comment_1="antitransfer"', 'comment_2="mul mse, beta:20"',
                 'anti_transfer=True', 'at_beta=20.', 'at_type="mul_mse"'
                 ]
experiment[14] = ['comment_1="antitransfer"', 'comment_2="sum mse, beta:20"',
                 'anti_transfer=True', 'at_beta=20.', 'at_type="sum_mse"'
                 ]
