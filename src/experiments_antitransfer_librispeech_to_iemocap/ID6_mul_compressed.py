...
generator = True
num_experiment = 6  #id of the experiment
...
experiment[3] = ['comment_1="antitransfer"', 'comment_2="mul comp 0.001, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"']

experiment[4] = ['comment_1="antitransfer"', 'comment_2="mul comp 0.005, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp005"', 'at_distance="cos_squared"']

experiment[5] = ['comment_1="antitransfer"', 'comment_2="mul comp 0.01, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp01"', 'at_distance="cos_squared"']

experiment[6] = ['comment_1="antitransfer"', 'comment_2="mul comp 0.05, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp05"', 'at_distance="cos_squared"']

experiment[7] = ['comment_1="antitransfer"', 'comment_2="mul comp 0.1, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp1"', 'at_distance="cos_squared"']

experiment[8] = ['comment_1="antitransfer"', 'comment_2="mul no comp, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul"', 'at_distance="cos_squared"']

#mse

experiment[9] = ['comment_1="antitransfer"', 'comment_2="mul comp 0.005, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="mul_comp005"', 'at_distance="mse_sigmoid_invorder"']

experiment[10] = ['comment_1="antitransfer"', 'comment_2="mul comp 0.01, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="mul_comp01"', 'at_distance="mse_sigmoid_invorder"']

experiment[11] = ['comment_1="antitransfer"', 'comment_2="mul comp 0.05, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="mul_comp05"', 'at_distance="mse_sigmoid_invorder"']

experiment[12] = ['comment_1="antitransfer"', 'comment_2="mul comp 0.1, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="mul_comp1"', 'at_distance="mse_sigmoid_invorder"']

experiment[13] = ['comment_1="antitransfer"', 'comment_2="mul no comp, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
