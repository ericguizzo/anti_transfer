...
#beta 0.5
experiment[3] = ['comment_1="antitransfer"', 'comment_2="mean cos, beta:0.5"',
                 'anti_transfer=True', 'at_beta=0.5',
                 'at_aggregation="mean"', 'at_distance="cos_squared"']
experiment[4] = ['comment_1="antitransfer"', 'comment_2="sum cos, beta:0.5"',
                 'anti_transfer=True', 'at_beta=0.5',
                 'at_aggregation="sum"', 'at_distance="cos_squared"']
experiment[5] = ['comment_1="antitransfer"', 'comment_2="mul cos, beta:0.5"',
                 'anti_transfer=True', 'at_beta=0.5',
                 'at_aggregation="mul"', 'at_distance="cos_squared"']
experiment[6] = ['comment_1="antitransfer"', 'comment_2="max cos, beta:0.5"',
                 'anti_transfer=True', 'at_beta=0.5',
                 'at_aggregation="max"', 'at_distance="cos_squared"']


#beta 1.
experiment[7] = ['comment_1="antitransfer"', 'comment_2="mean cos, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mean"', 'at_distance="cos_squared"']
experiment[8] = ['comment_1="antitransfer"', 'comment_2="sum cos, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="sum"', 'at_distance="cos_squared"']
experiment[9] = ['comment_1="antitransfer"', 'comment_2="mul cos, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul"', 'at_distance="cos_squared"']
experiment[10] = ['comment_1="antitransfer"', 'comment_2="max cos, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="max"', 'at_distance="cos_squared"']


#beta 2.
experiment[11] = ['comment_1="antitransfer"', 'comment_2="mean cos, beta:2."',
                 'anti_transfer=True', 'at_beta=2.',
                 'at_aggregation="mean"', 'at_distance="cos_squared"']
experiment[12] = ['comment_1="antitransfer"', 'comment_2="sum cos, beta:2."',
                 'anti_transfer=True', 'at_beta=2.',
                 'at_aggregation="sum"', 'at_distance="cos_squared"']
experiment[13] = ['comment_1="antitransfer"', 'comment_2="mul cos, beta:2."',
                 'anti_transfer=True', 'at_beta=2.',
                 'at_aggregation="mul"', 'at_distance="cos_squared"']
experiment[14] = ['comment_1="antitransfer"', 'comment_2="max cos, beta:2."',
                 'anti_transfer=True', 'at_beta=2.',
                 'at_aggregation="max"', 'at_distance="cos_squared"']


#beta 5.
experiment[15] = ['comment_1="antitransfer"', 'comment_2="mean cos, beta:5."',
                 'anti_transfer=True', 'at_beta=5.',
                 'at_aggregation="mean"', 'at_distance="cos_squared"']
experiment[16] = ['comment_1="antitransfer"', 'comment_2="sum cos, beta:5."',
                 'anti_transfer=True', 'at_beta=5.',
                 'at_aggregation="sum"', 'at_distance="cos_squared"']
experiment[17] = ['comment_1="antitransfer"', 'comment_2="mul cos, beta:5."',
                 'anti_transfer=True', 'at_beta=5.',
                 'at_aggregation="mul"', 'at_distance="cos_squared"']
experiment[18] = ['comment_1="antitransfer"', 'comment_2="max cos, beta:5."',
                 'anti_transfer=True', 'at_beta=5.',
                 'at_aggregation="max"', 'at_distance="cos_squared"']


#beta 10.
experiment[19] = ['comment_1="antitransfer"', 'comment_2="mean cos, beta:10."',
                 'anti_transfer=True', 'at_beta=10.',
                 'at_aggregation="mean"', 'at_distance="cos_squared"']
experiment[20] = ['comment_1="antitransfer"', 'comment_2="sum cos, beta:10."',
                 'anti_transfer=True', 'at_beta=10.',
                 'at_aggregation="sum"', 'at_distance="cos_squared"']
experiment[21] = ['comment_1="antitransfer"', 'comment_2="mul cos, beta:10."',
                 'anti_transfer=True', 'at_beta=10.',
                 'at_aggregation="mul"', 'at_distance="cos_squared"']
experiment[22] = ['comment_1="antitransfer"', 'comment_2="max cos, beta:10."',
                 'anti_transfer=True', 'at_beta=10.',
                 'at_aggregation="max"', 'at_distance="cos_squared"']


#beta 20.
experiment[23] = ['comment_1="antitransfer"', 'comment_2="mean cos, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="mean"', 'at_distance="cos_squared"']
experiment[24] = ['comment_1="antitransfer"', 'comment_2="sum cos, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="sum"', 'at_distance="cos_squared"']
experiment[25] = ['comment_1="antitransfer"', 'comment_2="mul cos, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="mul"', 'at_distance="cos_squared"']
experiment[26] = ['comment_1="antitransfer"', 'comment_2="max cos, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="max"', 'at_distance="cos_squared"']
