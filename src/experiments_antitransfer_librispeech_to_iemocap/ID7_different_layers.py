...
experiment[1] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer0"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=0']

experiment[2] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer2"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=2']

experiment[3] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer5"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=5']

experiment[4] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer7"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=7']

experiment[5] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer10"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=10']

experiment[6] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer12"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=12']

experiment[7] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer14"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=14']

experiment[8] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer17"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=17']

experiment[9] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer19"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=19']

experiment[10] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer21"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=21']

experiment[11] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer24"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=24']

experiment[12] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer26"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=26']

experiment[13] = ['comment_1="antitransfer"', 'comment_2="mulcomp0.001,beta:1.,layer28"',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul_comp001"', 'at_distance="cos_squared"',
                 'at_layer=28']
