...
#beta 20.
experiment[3] = ['comment_1="antitransfer"', 'comment_2="mean mse_sigmoid_invorder, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="mean"', 'at_distance="mse_sigmoid_invorder"']
experiment[4] = ['comment_1="antitransfer"', 'comment_2="sum mse_sigmoid_invorder, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="sum"', 'at_distance="mse_sigmoid_invorder"']
experiment[5] = ['comment_1="antitransfer"', 'comment_2="mul mse_sigmoid_invorder, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="mul"', 'at_distance="mse_sigmoid_invorder"']
experiment[6] = ['comment_1="antitransfer"', 'comment_2="max mse_sigmoid_invorder, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="max"', 'at_distance="mse_sigmoid_invorder"']

experiment[7] = ['comment_1="antitransfer"', 'comment_2="mean mse_sigmoid_invorder, beta:30."',
                 'anti_transfer=True', 'at_beta=30.',
                 'at_aggregation="mean"', 'at_distance="mse_sigmoid_invorder"']
experiment[8] = ['comment_1="antitransfer"', 'comment_2="sum mse_sigmoid_invorder, beta:30."',
                 'anti_transfer=True', 'at_beta=30.',
                 'at_aggregation="sum"', 'at_distance="mse_sigmoid_invorder"']
experiment[9] = ['comment_1="antitransfer"', 'comment_2="mul mse_sigmoid_invorder, beta:30."',
                 'anti_transfer=True', 'at_beta=30.',
                 'at_aggregation="mul"', 'at_distance="mse_sigmoid_invorder"']
experiment[10] = ['comment_1="antitransfer"', 'comment_2="max mse_sigmoid_invorder, beta:30."',
                 'anti_transfer=True', 'at_beta=30.',
                 'at_aggregation="max"', 'at_distance="mse_sigmoid_invorder"']

experiment[11] = ['comment_1="antitransfer"', 'comment_2="mean mse_sigmoid_invorder, beta:50."',
                 'anti_transfer=True', 'at_beta=50.',
                 'at_aggregation="mean"', 'at_distance="mse_sigmoid_invorder"']
experiment[12] = ['comment_1="antitransfer"', 'comment_2="sum mse_sigmoid_invorder, beta:50."',
                 'anti_transfer=True', 'at_beta=50.',
                 'at_aggregation="sum"', 'at_distance="mse_sigmoid_invorder"']
experiment[13] = ['comment_1="antitransfer"', 'comment_2="mul mse_sigmoid_invorder, beta:50."',
                 'anti_transfer=True', 'at_beta=50.',
                 'at_aggregation="mul"', 'at_distance="mse_sigmoid_invorder"']
experiment[14] = ['comment_1="antitransfer"', 'comment_2="max mse_sigmoid_invorder, beta:50."',
                 'anti_transfer=True', 'at_beta=50.',
                 'at_aggregation="max"', 'at_distance="mse_sigmoid_invorder"']

experiment[15] = ['comment_1="antitransfer"', 'comment_2="mean mse_sigmoid_invorder, beta:100."',
                 'anti_transfer=True', 'at_beta=100.',
                 'at_aggregation="mean"', 'at_distance="mse_sigmoid_invorder"']
experiment[16] = ['comment_1="antitransfer"', 'comment_2="sum mse_sigmoid_invorder, beta:100."',
                 'anti_transfer=True', 'at_beta=100.',
                 'at_aggregation="sum"', 'at_distance="mse_sigmoid_invorder"']
experiment[17] = ['comment_1="antitransfer"', 'comment_2="mul mse_sigmoid_invorder, beta:100."',
                 'anti_transfer=True', 'at_beta=100.',
                 'at_aggregation="mul"', 'at_distance="mse_sigmoid_invorder"']
experiment[18] = ['comment_1="antitransfer"', 'comment_2="max mse_sigmoid_invorder, beta:100."',
                 'anti_transfer=True', 'at_beta=1200.',
                 'at_aggregation="max"', 'at_distance="mse_sigmoid_invorder"']
