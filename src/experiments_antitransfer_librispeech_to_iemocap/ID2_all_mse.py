...
short_description = 'inverted beta. now is sigmoid/*-1/*beta. before was the opposite'
...
experiment[1] = ['comment_1="regular"', 'comment_2="none"',
                 'anti_transfer=False',
                 ]

experiment[2] = ['comment_1="antitransfer"', 'comment_2="standard mse"',
                 'anti_transfer=True', 'at_beta=2.',
                 ]

#beta 0.5
experiment[3] = ['comment_1="antitransfer"', 'comment_2="mean mse, beta:0.5"',
                 'anti_transfer=True', 'at_beta=0.5',
                 'at_aggregation="mean"', 'at_distance="mse_sigmoid"']
experiment[4] = ['comment_1="antitransfer"', 'comment_2="sum mse, beta:0.5"',
                 'anti_transfer=True', 'at_beta=0.5',
                 'at_aggregation="sum"', 'at_distance="mse_sigmoid"']
experiment[5] = ['comment_1="antitransfer"', 'comment_2="mul mse, beta:0.5"',
                 'anti_transfer=True', 'at_beta=0.5',
                 'at_aggregation="mul"', 'at_distance="mse_sigmoid"']
experiment[6] = ['comment_1="antitransfer"', 'comment_2="max mse, beta:0.5"',
                 'anti_transfer=True', 'at_beta=0.5',
                 'at_aggregation="max"', 'at_distance="mse_sigmoid"']


#beta 1.
experiment[7] = ['comment_1="antitransfer"', 'comment_2="mean mse, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mean"', 'at_distance="mse_sigmoid"']
experiment[8] = ['comment_1="antitransfer"', 'comment_2="sum mse, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="sum"', 'at_distance="mse_sigmoid"']
experiment[9] = ['comment_1="antitransfer"', 'comment_2="mul mse, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="mul"', 'at_distance="mse_sigmoid"']
experiment[10] = ['comment_1="antitransfer"', 'comment_2="max mse, beta:1."',
                 'anti_transfer=True', 'at_beta=1.',
                 'at_aggregation="max"', 'at_distance="mse_sigmoid"']


#beta 2.
experiment[11] = ['comment_1="antitransfer"', 'comment_2="mean mse, beta:2."',
                 'anti_transfer=True', 'at_beta=2.',
                 'at_aggregation="mean"', 'at_distance="mse_sigmoid"']
experiment[12] = ['comment_1="antitransfer"', 'comment_2="sum mse, beta:2."',
                 'anti_transfer=True', 'at_beta=2.',
                 'at_aggregation="sum"', 'at_distance="mse_sigmoid"']
experiment[13] = ['comment_1="antitransfer"', 'comment_2="mul mse, beta:2."',
                 'anti_transfer=True', 'at_beta=2.',
                 'at_aggregation="mul"', 'at_distance="mse_sigmoid"']
experiment[14] = ['comment_1="antitransfer"', 'comment_2="max mse, beta:2."',
                 'anti_transfer=True', 'at_beta=2.',
                 'at_aggregation="max"', 'at_distance="mse_sigmoid"']


#beta 5.
experiment[15] = ['comment_1="antitransfer"', 'comment_2="mean mse, beta:5."',
                 'anti_transfer=True', 'at_beta=5.',
                 'at_aggregation="mean"', 'at_distance="mse_sigmoid"']
experiment[16] = ['comment_1="antitransfer"', 'comment_2="sum mse, beta:5."',
                 'anti_transfer=True', 'at_beta=5.',
                 'at_aggregation="sum"', 'at_distance="mse_sigmoid"']
experiment[17] = ['comment_1="antitransfer"', 'comment_2="mul mse, beta:5."',
                 'anti_transfer=True', 'at_beta=5.',
                 'at_aggregation="mul"', 'at_distance="mse_sigmoid"']
experiment[18] = ['comment_1="antitransfer"', 'comment_2="max mse, beta:5."',
                 'anti_transfer=True', 'at_beta=5.',
                 'at_aggregation="max"', 'at_distance="mse_sigmoid"']


#beta 10.
experiment[19] = ['comment_1="antitransfer"', 'comment_2="mean mse, beta:10."',
                 'anti_transfer=True', 'at_beta=10.',
                 'at_aggregation="mean"', 'at_distance="mse_sigmoid"']
experiment[20] = ['comment_1="antitransfer"', 'comment_2="sum mse, beta:10."',
                 'anti_transfer=True', 'at_beta=10.',
                 'at_aggregation="sum"', 'at_distance="mse_sigmoid"']
experiment[21] = ['comment_1="antitransfer"', 'comment_2="mul mse, beta:10."',
                 'anti_transfer=True', 'at_beta=10.',
                 'at_aggregation="mul"', 'at_distance="mse_sigmoid"']
experiment[22] = ['comment_1="antitransfer"', 'comment_2="max mse, beta:10."',
                 'anti_transfer=True', 'at_beta=10.',
                 'at_aggregation="max"', 'at_distance="mse_sigmoid"']


#beta 20.
experiment[23] = ['comment_1="antitransfer"', 'comment_2="mean mse, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="mean"', 'at_distance="mse_sigmoid"']
experiment[24] = ['comment_1="antitransfer"', 'comment_2="sum mse, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="sum"', 'at_distance="mse_sigmoid"']
experiment[25] = ['comment_1="antitransfer"', 'comment_2="mul mse, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="mul"', 'at_distance="mse_sigmoid"']
experiment[26] = ['comment_1="antitransfer"', 'comment_2="max mse, beta:20."',
                 'anti_transfer=True', 'at_beta=20.',
                 'at_aggregation="max"', 'at_distance="mse_sigmoid"']
