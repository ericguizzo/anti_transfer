...
def main():
    ...
    if AUGMENTATION:
        predictors_save_path = os.path.join(OUTPUT_FOLDER, 'goodsounds_randsplit' + appendix + '_aug' + str(NUM_AUG_SAMPLES) + '_predictors.npy')
        target_save_path = os.path.join(OUTPUT_FOLDER, 'goodsounds_randsplit' + appendix + '_aug' + str(NUM_AUG_SAMPLES) + '_target.npy')
    else:
        predictors_save_path = os.path.join(OUTPUT_FOLDER, 'goodsounds_randsplit' + appendix + '_predictors.npy')
        target_save_path = os.path.join(OUTPUT_FOLDER, 'goodsounds_randsplit' + appendix + '_target.npy')
    ...
    for i in sounds_list:
        ...
        curr_predictors, curr_target = pre.preprocess_foldable_item(curr_list, max_file_length, get_lable_GOODSOUNDS)
