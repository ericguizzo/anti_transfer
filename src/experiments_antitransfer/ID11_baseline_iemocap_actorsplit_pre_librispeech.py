...
short_description = 'baseline with no antitransfer, but with weight initialization, iemocap speaker-wise pretrained on librispeech'
...
experiment[1] = ['comment_1="no antitransfer"', 'comment_2="weight init librispeech"',
                 'anti_transfer=False', 'at_pretraining="librispeech"',
                 ]

experiment[2] = ['comment_1="no antitransfer"', 'comment_2="weight init librispeech"',
                 'anti_transfer=False', 'at_pretraining="librispeech"',
                 ]

experiment[3] = ['comment_1="no antitransfer"', 'comment_2="weight init librispeech"',
                 'anti_transfer=False', 'at_pretraining="librispeech"',
                 ]
