...
short_description = 'baseline with no antitransfer, but with weight initialization, gsc noisy randsplit pretrained on noisyspeech'
dataset = 'gsc_noisy_randsplit_spectrum_fast'
task_type = 'classification'
generator = True
num_experiment = 34  #id of the experiment
