...
short_description = 'baseline with no antitransfer, but with weight initialization, gsc noisy more randsplit pretrained on noisyspeech'
dataset = 'gsc_noisy_more_randsplit_spectrum_fast'
task_type = 'classification'
generator = True
num_experiment = 35  #id of the experiment
...
experiment[1] = ['comment_1="no antitransfer"', 'comment_2="weight init noisyspeech"',
                 'anti_transfer=False', 'at_pretraining="iemocap_1sec"',
                 ]

experiment[2] = ['comment_1="no antitransfer"', 'comment_2="weight init noisyspeech"',
                 'anti_transfer=False', 'at_pretraining="iemocap_1sec"',
                 ]

experiment[3] = ['comment_1="no antitransfer"', 'comment_2="weight init noisyspeech"',
                 'anti_transfer=False', 'at_pretraining="iemocap_1sec"',
                 ]
