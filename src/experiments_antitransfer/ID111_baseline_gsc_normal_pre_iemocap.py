...
short_description = 'baseline with no antitransfer, but with weight initialization, gsc randsplit pretrained on noisyspeech'
dataset = 'gsc_randsplit_spectrum_fast'
task_type = 'classification'
generator = True
num_experiment = 33  #id of the experiment
