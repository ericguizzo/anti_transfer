...
short_description = 'baseline NO antitransfer Good-Sounds instrument-wise split'
dataset = 'goodsounds_instrumentsplit_spectrum_fast'
...
global_parameters = ['output_classes=5',
                     'batch_size=30',
                     'architecture="vgg16"',
