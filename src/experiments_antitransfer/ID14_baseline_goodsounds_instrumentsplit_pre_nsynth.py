...
generator = True
num_experiment = 14  #id of the experiment
...
experiment[1] = ['comment_1="no antitransfer"', 'comment_2="weight init nsynth"',
                 'anti_transfer=False', 'at_pretraining="nsynth"',
                 ]

experiment[2] = ['comment_1="no antitransfer"', 'comment_2="weight init nsynth"',
                 'anti_transfer=False', 'at_pretraining="nsynth"',
                 ]

experiment[3] = ['comment_1="no antitransfer"', 'comment_2="weight init nsynth"',
                 'anti_transfer=False', 'at_pretraining="nsynth"',
                 ]
