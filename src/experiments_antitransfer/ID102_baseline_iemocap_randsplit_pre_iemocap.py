...
short_description = 'baseline with no antitransfer, but with weight initialization, iemocap randsplit pretrained on iemocap'
dataset = 'iemocap_randsplit_spectrum_fast'
task_type = 'classification'
generator = True
num_experiment = 12  #id of the experiment
...
experiment[3] = ['comment_1="no antitransfer"', 'comment_2="weight init iemocap"',
                 'anti_transfer=False', 'at_pretraining="iemocap"',
                 ]
