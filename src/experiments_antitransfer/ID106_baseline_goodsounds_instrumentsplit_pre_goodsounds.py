...
generator = True
num_experiment = 16  #id of the experiment
...
experiment[1] = ['comment_1="no antitransfer"', 'comment_2="weight init goodsounds"',
                 'anti_transfer=False', 'at_pretraining="goodsounds"',
                 ]

experiment[2] = ['comment_1="no antitransfer"', 'comment_2="weight init goodsounds"',
                 'anti_transfer=False', 'at_pretraining="goodsounds"',
                 ]

experiment[3] = ['comment_1="no antitransfer"', 'comment_2="weight init goodsounds"',
                 'anti_transfer=False', 'at_pretraining="goodsounds"',
                 ]
