...
short_description = 'baseline NO antitransfer Google Speech Commands random split'
dataset = 'gsc_noisy_more_randsplit_spectrum_fast'
task_type = 'classification'
generator = True
num_experiment = 7  #id of the experiment
...
experiment[1] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[2] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[3] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[4] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[5] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[6] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[7] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[8] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[9] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[10] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[11] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[12] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[13] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[14] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[15] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[16] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[17] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[18] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[19] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]

experiment[20] = ['comment_1="no weight init"', 'comment_2="no antitransfer"',
                 'anti_transfer=False',
                 ]
