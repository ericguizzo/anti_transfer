...
short_description = 'baseline with no antitransfer, but with weight initialization, morphomnist pretrained on morphomnist'
dataset = 'morphomnist_digits'
task_type = 'classification'
generator = True
num_experiment = 61  #id of the experiment
...
experiment[1] = ['comment_1="no antitransfer"', 'comment_2="weight init morphomnist_morpholabel"',
                 'anti_transfer=False', 'at_pretraining="morphomnist_morpholabel"',
                 ]

experiment[2] = ['comment_1="no antitransfer"', 'comment_2="weight init morphomnist_morpholabel"',
                 'anti_transfer=False', 'at_pretraining="morphomnist_morpholabel"',
                 ]

experiment[3] = ['comment_1="no antitransfer"', 'comment_2="weight init morphomnist_morpholabel"',
                 'anti_transfer=False', 'at_pretraining="morphomnist_morpholabel"',
                 ]
